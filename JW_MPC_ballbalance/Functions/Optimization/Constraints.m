function [x,u,dv] = Constraints(Th,Nodes,Ad,Bd,xd_lb,xd_ub,vd_lb,vd_ub)
    ...
    % Dermine the Lengths of the Input Matricies & Nodes
     ...
     matlabFunction(Aeq,beq,'File','/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/AutoGenerated/EqualityConstraints','vars',{x_ic},'Outputs',{'Aeq','beq'}); 
     disp('Generating Inequality Constraint Function...') 
     matlabFunction(Aiq,biq,'File','/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/AutoGenerated/InequalityConstraints','vars',{x_ic},'Outputs',{'Aiq','biq'}); 
end
