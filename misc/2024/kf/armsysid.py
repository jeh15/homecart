...
if __name__ == "__main__":
    ...
    armsysid(rtde_c, rtde_r,frequency=0.5)

    # go to initial position
    go_to_initial_pos(rtde_c, rtde_r, p0)

    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=0.75)

    # go to initial position
    go_to_initial_pos(rtde_c, rtde_r, p0)

    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=1.0)
    ...
    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=1.25)
    ...
    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=1.5)
    ...
    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=2.0)
    ...
    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=3.0)
    ...
    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=4.0)

    # go to initial position
    go_to_initial_pos(rtde_c, rtde_r, p0)    

    # run system identification function
    armsysid(rtde_c, rtde_r,frequency=5.0)
