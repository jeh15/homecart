...
def ball_state(frames, last_pos, last_vel, last_acc, last_time, depth_scale, stream_flag,iteration,out, time_now):
    ...
    bx0 = -0.53   # pivot point in x axis
...
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance')
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance/Functions')
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/AutoGenerated')
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/Dynamics')
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/Geometry')
eng.addpath('/home/orl/repository/homecart/JW_MPC_ballbalance/Functions/Optimization')
...
try:
    while ((time.time() - initial_time) < test_duration) and (int(joint_angles[4]) in range(angle_range[0],angle_range[1]) ):
        ...
        if iteration == 0:
            ...
            my_filter.B = np.array([[0.],
                                    [0.],
                                    [5.886]])    # state transition matrix golf - 7.0071, pingpong - 5.886
            my_filter.H = np.array([[1.,0.,0.]])    # Measurement function
            my_filter.P *= 1000.                 # covariance matrix originally 1000
            my_filter.R = 5                      # state uncertainty
            my_filter.Q = Q_discrete_white_noise(dim=3, dt=0.1/3., var=0.1) # process uncertainty
    ...
    filename = "./data/data_movel_2d_kf_newpivot_" + timestamp + ".csv"
