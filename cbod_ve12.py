...
try:
    while True:
        ...
        cv2.putText(color_image, f"Vel: {vel[0]:.4f} {vel[1]:.4f} {vel[2]:.4f} m/s", (100,100), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0,0,0), 1)
        cv2.putText(color_image, f"Pos: {pos[0]:.2f} {pos[1]:.2f} {pos[2]:.2f} m", (200,200), cv2.FONT_HERSHEY_COMPLEX, 1.0, (0,0,0), 1)
