...
2. get arm position and velocity
3. forward them to mpc to get desired arm velocity
4. run 2 iterations inside a loop 

Test:
- from flat - command low rot vel for 2 seconds
- look at ball p,v data and arm p, v data 
- run this and plot the data
'''
# -----------------------------------------------------------
...
try:
    ...
    filename = "./data/board_model_" + timestamp + ".csv"
