...
M = readmatrix("data/stsmpc_2024_09_17-07_12_14_PM.csv");
videoname = '/home/orl/Downloads/homecart_misc/videos/out_09_17_2024_1912_stsmpcchange1.avi';
numFrames = 122-1;
prefix = '/home/orl/Downloads/vid2pix/stsmpc_v1_test1/frame';
...
%% MPC
addpath(genpath([pwd '/t1_3f/Functions']))
addpath(genpath([pwd '/t1_3f']))
...
% ===== ball pos ====    
    ...
    % generate x traj
    x0 = [ball_pos(1:i)', ball_vel(1:i)', ball_acc(1:i)', ball_jerk(1:i)']';

    if i==1
        u = [];
    end

    [u,p_M, mu_gamma_M,var_gamma_M] = run_stsmpc(A , B , Ts , Q , R , n_x , n_u , n_m , true_gamma , mW ,  varW , ivarW , mu_gamma_M , var_gamma_M , p_M ,  x0 ,  T , N , k_fault , delay , ref,  N_s , L , w_ , simulation , sol, i, u);
...
% ===== control input traj ====    
    ...
    subplot(4,2,2)
    % subplot(1,2,2)
    plot(time(1:i),target_true_vel(1:i),'.-b',"MarkerSize",12)
    % hold on
    % plot(time(i)+t_traj2,u_traj(1:end-1),'.-r',"MarkerSize",12)
